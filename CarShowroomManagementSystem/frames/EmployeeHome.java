...
public class EmployeeHome extends JFrame implements ActionListener
{
	...
	public EmployeeHome(User user)
	{
		...
		manageProductBtn = new JButton("Manage Cars");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			ManageCars mc = new ManageCars(user);
			mc.setVisible(true);
			this.setVisible(false);
		...
		{
			ManagePurchaseFrame mpf= new ManagePurchaseFrame(user);
			mpf.setVisible(true);
			this.setVisible(false);
		}
		else if(command.equals(changePasswordBtn.getText()))
		{
			ChangePasswordFrame cpf=new ChangePasswordFrame(user);
			cpf.setVisible(true);
			this.setVisible(false);
		}
		else{}
